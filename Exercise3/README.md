Optional Exercise 3 : Single Elevator
============================
This exercise is no longer mandatory, but it can be a helpful way to understand how to make progress on your project. It provides an opportunity to explore concepts in a smaller context before working on the main project, which can be especially useful for those who did not take the course TTK4235. Here, the teaching assistants can help you understand how a single elevator is expected to work, which is closely related to how the triple elevator should function.
